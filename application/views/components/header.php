<header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
  <div class="container flex items-center justify-between h-full px-6 mx-auto text-blue-500 dark:text-blue-400">
    <!-- Mobile hamburger -->
    ...
    <ul class="flex items-center flex-shrink-0 space-x-6">
      ...
      <li class="relative">
        ...
        aria-haspopup="true">
          <img class="object-cover w-8 h-8 rounded-full" src="<?= base_url('assets/img/default-profile.jpg') ?>"
