...
$route['api/auth/(:any)'] = 'api_auth/$1';
$route['api/setting'] = 'api_setting/index';
...
$route['api/project/validate-strategies'] = 'api_project/validate_strategies';

$route['api/project'] = 'api_project/index';
$route['api/project/(:any)'] = 'api_project/$1';
$route['api/subscription'] = 'api_subscription/index';
$route['api/subscription/(:any)'] = 'api_subscription/$1';
