        ...
        <main class="h-full overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
              <!-- Card -->
              <a href="#"
                class="flex items-center p-4 rounded-lg shadow-xs text-green-500 bg-green-100 text-center"
              ...
              >
                ...
                <a href="#" class="btn gradient-primary btn-block btn-sm mt-4">
                  Open Project
                </a>
              </div>
              <!-- Card -->
              ...
              >
                ...
                <!-- Overlay -->
                <a href="#" class="dashboard-project-card-overlay">
                  Show All Projects
                </a>
              </div>
            </div>
