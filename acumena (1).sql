...
CREATE TABLE `subscriptions` (
  ...
  `max_step` varchar(255) DEFAULT NULL,
  `project_api_generate_quota` int DEFAULT '0',
  `price_monthly` decimal(10,0) NOT NULL,
  `price_yearly` decimal(10,0) NOT NULL,
  `label` json NOT NULL,
  `date_created` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `last_update` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `is_deleted` timestamp NULL DEFAULT NULL
...
INSERT INTO `subscriptions` (`id`, `name`, `project_qty`, `max_step`, `project_api_generate_quota`, `price_monthly`, `price_yearly`, `label`, `date_created`, `last_update`, `is_deleted`) VALUES
(1, 'Trial', 1, 'matrix-ie', 0, '0', '0', '{\"icon\": null, \"text_color\": \"#fff\", \"background_color\": \"#ff6600\"}', '2025-10-24 12:45:07', '2025-11-04 12:34:50', NULL),
(2, 'Pro Plan', 0, NULL, 0, '200000', '2000000', '{\"icon\": null, \"text_color\": \"#fff\", \"background_color\": \"#ff6600\"}', '2025-10-24 12:48:27', '2025-10-31 03:09:32', NULL);
